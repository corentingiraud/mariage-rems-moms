...
<div class='page' id={PAGE_IDS.HOME}>
	<div class='vigne-wrapper'>
		<img alt='Vignes' class='vigne' src={Vigne} />
	</div>
	<div class='content'>
		<h1>Morgane & Rémy</h1>
		<h1>Samedi 24 Août 2024</h1>
		<h1>Château de Beauchamp</h1>
  ...
  .content {
    ...
    .button-wrapper {
      ...
      .info-button {
        ...
        height: 40px;
        border-radius: 4px;
        box-shadow: 5px 7px 20px -15px rgba(0, 0, 0, 0.77);
